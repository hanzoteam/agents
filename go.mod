...
require (
	...
	github.com/modelcontextprotocol/go-sdk v1.7.1-0.20260730080614-7743b71b1cd5
...
// The server this plugin runs in serves its API at model.APIURLSuffix, and this
// module is where that constant lives — so the client the plugin builds addresses
// the right routes by construction rather than by a prefix spelled here too.
replace github.com/mattermost/mattermost/server/public => github.com/hanzoteam/server/server/public v0.4.4
